...
import ConsultaPessoas from '../views/pessoas/consulta-pessoas'
import CadastroPessoas from '../views/pessoas/cadastro-pessoas'
    ...
    return (
        <HashRouter>
            <Switch>
                ...
                <RotaAutenticada isUsuarioAutenticado={props.isUsuarioAutenticado} path="/consulta-pessoas" component={ConsultaPessoas} />
                <RotaAutenticada isUsuarioAutenticado={props.isUsuarioAutenticado} path="/cadastro-pessoas/:id?" component={CadastroPessoas} />
